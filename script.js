...
// Création de 3 variables pour chacun des 3 commerces de location de cabanes de pêche (entités ponctuelles)
...
var overlayMaps = {
    "Location de cabanes de pêche": locCabane,
...
legend.onAdd = function(map) {
  ...
  div.innerHTML += '<i class="icon" style="background-image: url(\'../Images/pecheur.png\'); background-repeat: no-repeat;"></i><span>Location de cabanes</span><br>';
  // Paramétrage d'un svg (vecteur ... une ligne) représentant les sentiers de motoneige avec la symbologie la plus proche possible
  div.innerHTML += '<svg height="15" width="40"><line x1="0" y1="10" x2="30" y2="10" style="stroke:dodgerblue;stroke-width:2.5" /></svg><span>Sentiers de motoneige</span><br>';
...
circle1.bindPopup("Village de pêche 1");
circle2.bindPopup("Village de pêche 2");
